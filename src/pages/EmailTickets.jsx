...
import { receivedEmailTableHeaders, receivedEmailData } from '../data/receivedEmail'
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col gap-4 w-full h-full bg-slate-50 py-2 p-4 pr-6">
          ...
          <div className="bg-white p-3 shadow-lg h-fit w-full">
            ...
            <Table headers={receivedEmailTableHeaders} data={receivedEmailData} onAction={handleViewTicket} />
            <ReusableTicketModal
