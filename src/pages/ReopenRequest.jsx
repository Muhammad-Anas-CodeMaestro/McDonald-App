...
import { reOpenTicketTableHeaders, reOpenTicketData } from "../data/reopenTicket"

export default function ReopenRequest() {
    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col gap-4 w-full h-full bg-slate-50 py-2 p-4 pr-6">
          <h2 className="font-semibold text-2xl">Re-Open Request</h2>
          <div className="bg-white p-3 shadow-lg h-fit w-full">
            <TicketHeader showTabs={false} />
            <Table headers={reOpenTicketTableHeaders} data={reOpenTicketData} onAction={handleViewTicket} />
            <ReusableTicketModal
